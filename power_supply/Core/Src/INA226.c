...
void INA226_WriteReg(uint16_t data, uint8_t reg_addr)
{
	...
	buffer[0] = (data >> 8) & 0xFF;
 	HAL_I2C_Mem_Write(&hi2c1, (INA226_ADDR << 1), reg_addr, I2C_MEMADD_SIZE_8BIT, buffer, 2, HAL_MAX_DELAY);
}
